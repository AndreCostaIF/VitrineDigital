            ...
            <div class="span8">
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="pull-right"><span class="badge badge-error">10 Images</span></div>
                    </div>
            ...
            <div class="span4">
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="pull-right"><span class="badge badge-warning">Some short message</span></div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span12">
                            <h5>Short Description</h5>
                            <p class="muted">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
                            ...
                            <form class="form-inline">
                              <div class="control-group">
                                    ...
                                    <input type="text" id="name" value="1" placeholder="Quantity" class="input-mini">
